...
static __pio_const uint16_t pio_i2s_mclk_program_instructions[] = {
    //     .wrap_target
    0xe001, //  0: set    pins, 1
    0xe000, //  1: set    pins, 0
    //     .wrap
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_i2s_mclk_program = {
...
static __pio_const uint16_t pio_i2s_out_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_i2s_out_program = {
...
static __pio_const uint16_t pio_i2s_out_slave_16_program_instructions[] = {
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_i2s_out_slave_16_program = {
...
static __pio_const uint16_t pio_i2s_out_slave_32_program_instructions[] = {
    0x2020, //  0: wait   0 pin, 0
    0x20a0, //  1: wait   1 pin, 0
    0x00c0, //  2: jmp    pin, 0
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_i2s_out_slave_32_program = {
...
static __pio_const uint16_t pio_tdm_out_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_tdm_out_program = {
...
static __pio_const uint16_t pio_tdm_inout_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_tdm_inout_program = {
...
static __pio_const uint16_t pio_lsbj_out_program_instructions[] = {
    //     .wrap_target
    0xa822, //  0: mov    x, y            side 1
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_lsbj_out_program = {
...
static __pio_const uint16_t pio_i2s_in_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_i2s_in_program = {
...
static __pio_const uint16_t pio_i2s_in_slave_program_instructions[] = {
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_i2s_in_slave_program = {
...
static __pio_const uint16_t pio_i2s_inout_program_instructions[] = {
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_i2s_inout_program = {

...
static __pio_const uint16_t spi_cpha0_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program spi_cpha0_program = {
...
static __pio_const uint16_t spi_cpha1_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program spi_cpha1_program = {
...
static __pio_const uint16_t spi_cpha0_cs_program_instructions[] = {
    //     .wrap_target
    0x6101, //  0: out    pins, 1         side 0 [1]
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program spi_cpha0_cs_program = {
...
static __pio_const uint16_t spi_cpha1_cs_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program spi_cpha1_cs_program = {

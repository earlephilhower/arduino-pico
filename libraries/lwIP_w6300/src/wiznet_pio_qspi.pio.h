...
static __pio_const uint16_t wiznet_spi_write_read_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program wiznet_spi_write_read_program = {
...
static __pio_const uint16_t wizchip_pio_spi_single_write_read_program_instructions[] = {
    //     .wrap_target
    0x6001, //  0: out    pins, 1         side 0
    0x1040, //  1: jmp    x--, 0          side 1
    0xe000, //  2: set    pins, 0         side 0
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program wizchip_pio_spi_single_write_read_program = {
...
static __pio_const uint16_t wizchip_pio_spi_dual_write_read_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program wizchip_pio_spi_dual_write_read_program = {
...
static __pio_const uint16_t wizchip_pio_spi_quad_write_read_program_instructions[] = {
    //     .wrap_target
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program wizchip_pio_spi_quad_write_read_program = {

...
def header(zones):
    ...
    print(f"// python3 -m venv upd; source upd/bin/activate; pip3 install tzdata; python3 <arduino-pico core>/tools/{sys.argv[0]} > TZ.h; deactivate")
    print()
    print("#pragma once")
    print()
    for name, value in zones:
        print(f'#define TZ_{fix_name(name)}\t("{value}")')

...
__freertos_recursive_mutex *__lock___atexit_recursive_mutex_freertos;
__freertos_mutex *__lock___at_quick_exit_mutex_freertos;
__freertos_recursive_mutex *__lock___malloc_recursive_mutex_freertos;
__freertos_recursive_mutex *__lock___env_recursive_mutex_freertos;
__freertos_mutex *__lock___tz_mutex_freertos;
__freertos_mutex *__lock___dd_hash_mutex_freertos;
__freertos_mutex *__lock___arc4random_mutex_freertos;
...
static __freertos_mutex *__getFreeRTOSMutex(_LOCK_T lock) {
...
static __freertos_recursive_mutex *__getFreeRTOSRecursiveMutex(_LOCK_T lock) {
...
void __retarget_lock_acquire(_LOCK_T lock) {
    if (__freeRTOSinitted) {
        __freertos_mutex *mtx = __getFreeRTOSMutex(lock);
...
void __retarget_lock_acquire_recursive(_LOCK_T lock) {
    if (__freeRTOSinitted) {
        __freertos_recursive_mutex *mtx = __getFreeRTOSRecursiveMutex(lock);

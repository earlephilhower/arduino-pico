...
// File created 2025-08-07 17:06:33.745592+00:00
// Based on IANA database 2025b
// python3 -m venv upd; source upd/bin/activate; pip3 install tzdata; python3 <arduino-pico core>/tools/./format_tzdata.py > TZ.h; deactivate
...
#define TZ_Africa_Timbuktu	("GMT0")
...
#define TZ_America_Argentina_ComodRivadavia	("<-03>3")
...
#define TZ_America_Asuncion	("<-03>3")
#define TZ_America_Atikokan	("EST5")
#define TZ_America_Atka	("HST10HDT,M3.2.0,M11.1.0")
...
#define TZ_America_Buenos_Aires	("<-03>3")
...
#define TZ_America_Catamarca	("<-03>3")
...
#define TZ_America_Ciudad_Juarez	("MST7MDT,M3.2.0,M11.1.0")
#define TZ_America_Coral_Harbour	("EST5")
#define TZ_America_Cordoba	("<-03>3")
#define TZ_America_Costa_Rica	("CST6")
#define TZ_America_Coyhaique	("<-03>3")
...
#define TZ_America_Ensenada	("PST8PDT,M3.2.0,M11.1.0")
#define TZ_America_Fort_Nelson	("MST7")
#define TZ_America_Fort_Wayne	("EST5EDT,M3.2.0,M11.1.0")
...
#define TZ_America_Indianapolis	("EST5EDT,M3.2.0,M11.1.0")
...
#define TZ_America_Knox_IN	("CST6CDT,M3.2.0,M11.1.0")
...
#define TZ_America_Louisville	("EST5EDT,M3.2.0,M11.1.0")
...
#define TZ_America_Mendoza	("<-03>3")
...
#define TZ_America_Porto_Acre	("<-05>5")
...
#define TZ_America_Rosario	("<-03>3")
#define TZ_America_Santa_Isabel	("PST8PDT,M3.2.0,M11.1.0")
...
#define TZ_America_Scoresbysund	("<-02>2<-01>,M3.5.0/-1,M10.5.0/0")
#define TZ_America_Shiprock	("MST7MDT,M3.2.0,M11.1.0")
...
#define TZ_Antarctica_Casey	("<+08>-8")
...
#define TZ_Asia_Calcutta	("IST-5:30")
#define TZ_Asia_Chita	("<+09>-9")
#define TZ_Asia_Choibalsan	("<+08>-8")
#define TZ_Asia_Chongqing	("CST-8")
#define TZ_Asia_Chungking	("CST-8")
#define TZ_Asia_Colombo	("<+0530>-5:30")
#define TZ_Asia_Dacca	("<+06>-6")
...
#define TZ_Asia_Kashgar	("<+06>-6")
#define TZ_Asia_Kathmandu	("<+0545>-5:45")
#define TZ_Asia_Katmandu	("<+0545>-5:45")
...
#define TZ_Asia_Qostanay	("<+05>-5")
#define TZ_Asia_Qyzylorda	("<+05>-5")
#define TZ_Asia_Rangoon	("<+0630>-6:30")
#define TZ_Asia_Riyadh	("<+03>-3")
#define TZ_Asia_Saigon	("<+07>-7")
...
#define TZ_Asia_Tel_Aviv	("IST-2IDT,M3.4.4/26,M10.5.0")
#define TZ_Asia_Thimbu	("<+06>-6")
#define TZ_Asia_Thimphu	("<+06>-6")
#define TZ_Asia_Tokyo	("JST-9")
#define TZ_Asia_Tomsk	("<+07>-7")
#define TZ_Asia_Ujung_Pandang	("WITA-8")
#define TZ_Asia_Ulaanbaatar	("<+08>-8")
#define TZ_Asia_Ulan_Bator	("<+08>-8")
...
#define TZ_Atlantic_Faeroe	("WET0WEST,M3.5.0/1,M10.5.0")
#define TZ_Atlantic_Faroe	("WET0WEST,M3.5.0/1,M10.5.0")
#define TZ_Atlantic_Jan_Mayen	("CET-1CEST,M3.5.0,M10.5.0/3")
...
#define TZ_Australia_ACT	("AEST-10AEDT,M10.1.0,M4.1.0/3")
...
#define TZ_Australia_Canberra	("AEST-10AEDT,M10.1.0,M4.1.0/3")
...
#define TZ_Australia_LHI	("<+1030>-10:30<+11>-11,M10.1.0,M4.1.0")
...
#define TZ_Australia_NSW	("AEST-10AEDT,M10.1.0,M4.1.0/3")
#define TZ_Australia_North	("ACST-9:30")
#define TZ_Australia_Perth	("AWST-8")
#define TZ_Australia_Queensland	("AEST-10")
#define TZ_Australia_South	("ACST-9:30ACDT,M10.1.0,M4.1.0/3")
#define TZ_Australia_Sydney	("AEST-10AEDT,M10.1.0,M4.1.0/3")
#define TZ_Australia_Tasmania	("AEST-10AEDT,M10.1.0,M4.1.0/3")
#define TZ_Australia_Victoria	("AEST-10AEDT,M10.1.0,M4.1.0/3")
#define TZ_Australia_West	("AWST-8")
#define TZ_Australia_Yancowinna	("ACST-9:30ACDT,M10.1.0,M4.1.0/3")
#define TZ_Brazil_Acre	("<-05>5")
#define TZ_Brazil_DeNoronha	("<-02>2")
#define TZ_Brazil_East	("<-03>3")
#define TZ_Brazil_West	("<-04>4")
#define TZ_CET	("CET-1CEST,M3.5.0,M10.5.0/3")
#define TZ_CST6CDT	("CST6CDT,M3.2.0,M11.1.0")
#define TZ_Canada_Atlantic	("AST4ADT,M3.2.0,M11.1.0")
#define TZ_Canada_Central	("CST6CDT,M3.2.0,M11.1.0")
#define TZ_Canada_Eastern	("EST5EDT,M3.2.0,M11.1.0")
#define TZ_Canada_Mountain	("MST7MDT,M3.2.0,M11.1.0")
#define TZ_Canada_Newfoundland	("NST3:30NDT,M3.2.0,M11.1.0")
#define TZ_Canada_Pacific	("PST8PDT,M3.2.0,M11.1.0")
#define TZ_Canada_Saskatchewan	("CST6")
#define TZ_Canada_Yukon	("MST7")
#define TZ_Chile_Continental	("<-04>4<-03>,M9.1.6/24,M4.1.6/24")
#define TZ_Chile_EasterIsland	("<-06>6<-05>,M9.1.6/22,M4.1.6/22")
#define TZ_Cuba	("CST5CDT,M3.2.0/0,M11.1.0/1")
#define TZ_EET	("EET-2EEST,M3.5.0/3,M10.5.0/4")
#define TZ_EST	("EST5")
#define TZ_EST5EDT	("EST5EDT,M3.2.0,M11.1.0")
#define TZ_Egypt	("EET-2EEST,M4.5.5/0,M10.5.4/24")
#define TZ_Eire	("IST-1GMT0,M10.5.0,M3.5.0/1")
...
#define TZ_Europe_Belfast	("GMT0BST,M3.5.0/1,M10.5.0")
...
#define TZ_Europe_Nicosia	("EET-2EEST,M3.5.0/3,M10.5.0/4")
...
#define TZ_Europe_Tiraspol	("EET-2EEST,M3.5.0,M10.5.0/3")
#define TZ_Europe_Ulyanovsk	("<+04>-4")
#define TZ_Europe_Uzhgorod	("EET-2EEST,M3.5.0/3,M10.5.0/4")
#define TZ_Europe_Uzhhorod	("EET-2EEST,M3.5.0/3,M10.5.0/4")
...
#define TZ_Europe_Zaporizhzhia	("EET-2EEST,M3.5.0/3,M10.5.0/4")
#define TZ_Europe_Zaporozhye	("EET-2EEST,M3.5.0/3,M10.5.0/4")
#define TZ_Europe_Zurich	("CET-1CEST,M3.5.0,M10.5.0/3")
#define TZ_Factory	("<-00>0")
#define TZ_GB	("GMT0BST,M3.5.0/1,M10.5.0")
#define TZ_GBmEire	("GMT0BST,M3.5.0/1,M10.5.0")
#define TZ_GMT	("GMT0")
#define TZ_GMTp0	("GMT0")
#define TZ_GMTm0	("GMT0")
#define TZ_GMT0	("GMT0")
#define TZ_Greenwich	("GMT0")
#define TZ_HST	("HST10")
#define TZ_Hongkong	("HKT-8")
#define TZ_Iceland	("GMT0")
...
#define TZ_Iran	("<+0330>-3:30")
#define TZ_Israel	("IST-2IDT,M3.4.4/26,M10.5.0")
#define TZ_Jamaica	("EST5")
#define TZ_Japan	("JST-9")
#define TZ_Kwajalein	("<+12>-12")
#define TZ_Libya	("EET-2")
#define TZ_MET	("CET-1CEST,M3.5.0,M10.5.0/3")
#define TZ_MST	("MST7")
#define TZ_MST7MDT	("MST7MDT,M3.2.0,M11.1.0")
#define TZ_Mexico_BajaNorte	("PST8PDT,M3.2.0,M11.1.0")
#define TZ_Mexico_BajaSur	("MST7")
#define TZ_Mexico_General	("CST6")
#define TZ_NZ	("NZST-12NZDT,M9.5.0,M4.1.0/3")
#define TZ_NZmCHAT	("<+1245>-12:45<+1345>,M9.5.0/2:45,M4.1.0/3:45")
#define TZ_Navajo	("MST7MDT,M3.2.0,M11.1.0")
#define TZ_PRC	("CST-8")
#define TZ_PST8PDT	("PST8PDT,M3.2.0,M11.1.0")
...
#define TZ_Pacific_Johnston	("HST10")
#define TZ_Pacific_Kanton	("<+13>-13")
...
#define TZ_Pacific_Ponape	("<+11>-11")
#define TZ_Pacific_Port_Moresby	("<+10>-10")
#define TZ_Pacific_Rarotonga	("<-10>10")
#define TZ_Pacific_Saipan	("ChST-10")
#define TZ_Pacific_Samoa	("SST11")
#define TZ_Pacific_Tahiti	("<-10>10")
#define TZ_Pacific_Tarawa	("<+12>-12")
#define TZ_Pacific_Tongatapu	("<+13>-13")
#define TZ_Pacific_Truk	("<+10>-10")
#define TZ_Pacific_Wake	("<+12>-12")
#define TZ_Pacific_Wallis	("<+12>-12")
#define TZ_Pacific_Yap	("<+10>-10")
#define TZ_Poland	("CET-1CEST,M3.5.0,M10.5.0/3")
#define TZ_Portugal	("WET0WEST,M3.5.0/1,M10.5.0")
#define TZ_ROC	("CST-8")
#define TZ_ROK	("KST-9")
#define TZ_Singapore	("<+08>-8")
#define TZ_Turkey	("<+03>-3")
#define TZ_UCT	("UTC0")
#define TZ_US_Alaska	("AKST9AKDT,M3.2.0,M11.1.0")
#define TZ_US_Aleutian	("HST10HDT,M3.2.0,M11.1.0")
#define TZ_US_Arizona	("MST7")
#define TZ_US_Central	("CST6CDT,M3.2.0,M11.1.0")
#define TZ_US_EastmIndiana	("EST5EDT,M3.2.0,M11.1.0")
#define TZ_US_Eastern	("EST5EDT,M3.2.0,M11.1.0")
#define TZ_US_Hawaii	("HST10")
#define TZ_US_IndianamStarke	("CST6CDT,M3.2.0,M11.1.0")
#define TZ_US_Michigan	("EST5EDT,M3.2.0,M11.1.0")
#define TZ_US_Mountain	("MST7MDT,M3.2.0,M11.1.0")
#define TZ_US_Pacific	("PST8PDT,M3.2.0,M11.1.0")
#define TZ_US_Samoa	("SST11")
#define TZ_UTC	("UTC0")
#define TZ_Universal	("UTC0")
#define TZ_WmSU	("MSK-3")

...
static __pio_const uint16_t pio_tx_program_instructions[] = {
    //     .wrap_target
    0xe029, //  0: set    x, 9
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_tx_program = {
...
static __pio_const uint16_t pio_rx_program_instructions[] = {
    //     .wrap_target
    0xe032, //  0: set    x, 18
...
#if !PICO_NO_HARDWARE
static __pio_const struct pio_program pio_rx_program = {
